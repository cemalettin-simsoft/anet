...
public class CustomSensitiveInformationDao
  ...
  @InTransaction
  private CompletableFuture<CustomSensitiveInformation> getForRelatedObject(
      Map<String, Object> context, Person user, CustomSensitiveInformation csi) {
    ...
    return new ForeignKeyFetcher<CustomSensitiveInformation>()
        ...
        .thenApply(l -> {
          ...
          if (customSensitiveInformation != null) {
            AnetAuditLogger.log("ReportSensitiveInformation {} retrieved by {} ",
