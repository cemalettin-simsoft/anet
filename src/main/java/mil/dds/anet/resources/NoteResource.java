...
public class NoteResource {
  ...
  private Set<String> lazyLoadResponsibleTasks(Set<String> responsibleTasksUuids, Person user) {
  ...
  private Set<String> lazyLoadAssociatedPositions(Set<String> associatedPositionsUuids,
      Person user) {
